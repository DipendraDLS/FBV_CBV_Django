...
#     template_name = 'App_DeleteView/create.html'    # Create.html ma forms dekhauncha. By default template name chai 'student_form.html linxa 
...
#     #1) 
    ...
    #     return form
#     #NOTE: By givin class to Create form only it will not be added into Update form for that you need to add 'get_form' method in
...
# class StudentUpdateView(UpdateView):                # Yo view le CreateView kai form ma values haru display garaidinxa particualr 
                                                      #'id' ko so that we can edit it. 
#     model = Student                                 # models.py ma define vaye ko model ho.
#     fields = ['name', 'email', 'password']          # Forms ma kun kun field dekhauni ho tyo tyo yeta use huncha.
#     success_url = '/thanksupdate/'                  # Form submit vaye paXi kun url ma redirect huni vanni kura ho.
#     template_name = 'App_DeleteView/create.html'    # create.html vanni mai form display vayerako huncha CreateView ko through so tei form ma 
...
class StudentCreateView(CreateView):  
    ...
    template_name = 'App_DeleteView/create.html'
    success_url = '/thanks/'
...
class StudentDeleteView(DeleteView):
    ...
    template_name = 'App_DeleteView/confirm_delete.html'    # Yo iyena vani DleteView le lini default template is 'student_confirm_delete.html'
                                                            # so own template name dina cha vani we use 'template_name'
...
class ThanksTemplateView(TemplateView):             # Yo view le thanks.html template lai as a TemplateView ko through render garuna help garcha.
    template_name = 'App_DeleteView/thanks.html'
...
class ThanksUpdateTemplateView(TemplateView):       # Yo view le thanksupdate.html template lai as a TemplateView ko through render garuna help garcha.
    template_name = 'App_DeleteView/thanksupdate.html'

class ThanksDeleteTemplateView(TemplateView):
    template_name = 'App_DeleteView/thanksdelete.html'
